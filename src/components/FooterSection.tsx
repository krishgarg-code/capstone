...
export default function FooterSection() {
    ...
    return (
        <>
            <footer className="py-20 md:py-32 bg-black border-t border-white/10">
                <div className="mx-auto max-w-7xl px-6">
                    ...
                    <div className="my-12 flex flex-wrap justify-center gap-8 text-base md:text-lg">
                    ...
                    <span className="text-gray-400 block text-center text-base mt-8">© {new Date().getFullYear()} Viora, All rights reserved</span>
                </div>
            </footer>
